...
class SlotTemplate(Model):
    ...
    # Fields
    attendees = models.ManyToManyField(to='Person', blank=True, help_text='Attendees', related_name='+',
    ...
    tutors = models.ManyToManyField(to='Person', blank=True, help_text='Tutors', related_name='+',
